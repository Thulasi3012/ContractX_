...
from app.routes.Document_Extraction_routes import router as document_extraction_router
from app.routes.Chatbot_routes import router as chatbot_router
from app.routes.Document_Access_routes import router as document_access_router
from app.routes.rag_routes import router as Rag_services
from app.routes.KG_routes import router as kg_services
from app.routes.system_health_routes import router as System_health
from app.routes.AI_comparasion_routes import router as AI_comparasion_router
...
app.include_router(Rag_services)
app.include_router(kg_services)
app.include_router(System_health)
app.include_router(AI_comparasion_router)
