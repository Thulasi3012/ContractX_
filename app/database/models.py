...
class LLMUsage(Base):
    ...
    # JSON fields
    text_stats = Column(JSONB, default=dict)
    image_stats = Column(JSONB, default=dict)
    table_stats = Column(JSONB, default=dict)
    chat_agent_stats = Column(JSONB, default=dict)
    overall_stats = Column(JSONB, default=dict)
